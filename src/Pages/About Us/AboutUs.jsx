        ...
        <div>
            ...
            <div className='lg:flex justify-center items-center w-full flex-row-reverse  bg-gray-100'>
                ...
                <div className='p-10 flex-1'>
                    <h1 className="lg:text-5xl text-3xl font-bold">About ApexArtistry</h1>
                    <p className="py-6"> Welcome to ApexArtistry, a visionary platform founded by the passionate artist and entrepreneur, Philipp Sternberg. Born from the colorful streets where Philipp once wielded a spray can and dreams of creative freedom, ApexArtistry has evolved into a haven for artists worldwide.
                    </p>
                </div>
            ...
            <div className='lg:flex justify-center items-center w-full flex-row-reverse  bg-gray-100'>
                <div className='flex-1'>
                    <img className="w-full  lg:block shadow-2xl p-10 " src={img} />
                </div>
                <div className='p-10 flex-1'>
            ...
            <p>:
                ...
                Join Philipp Sternberg and the vibrant community at ApexArtistry. Together, let's embark on a journey to elevate art, support creativity, and make the world a more colorful and inspiring place.</p>
        </div>
    );
};
