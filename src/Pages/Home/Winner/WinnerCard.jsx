        ...
        <div>
            ...
            <div className="card bg-base-100 shadow-xl px-5 py-5">
                ...
                <div className="card-body">
                    ...
                    {
                        role ? <> <h2 className="card-title w-2/3 justify-start btn btn-outline bg-[#0F1111] text-white "><PiMedalBold />{role}</h2></> : <><h2 className="card-title w-2/3 justify-start btn btn-outline  text-white "></h2></>
                    }
                    ...
                    <div className="card-actions justify-end">
                        ...
                        <Link className="w-full" to={`/details/${_id}`}><button className="btn text-xl text-white hover:bg-orange-500 bg-orange-400 w-full mt-10">Details</button></Link>
                    </div>
                </div>
            </div>
        </div>
