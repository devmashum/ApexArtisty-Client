    ...
    return (
        <div className="flex ">
            <div className="lg:w-64 min-h-screen bg-gradient-to-r from-cyan-500 to-blue-500 pt-10">
                ...
                {
                    isUser ? <><h2 className="pl-5 divider text-xl border border-green-300 p-5 m-3 rounded-3xl font-bold">User Panel</h2>
                        <ul className="menu text-xl">
                ...
                <ul className="menu text-xl btn bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 m-5 text-white">
